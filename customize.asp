    ...
    <div class="customize-page">
        ...
        <section class="customize-section">
            <div class="section-header">
                <h2><i class="fas fa-flask"></i> 第一步：选择基础香型</h2>
                <p>不同的基础香型带来不同的整体风格</p>
            </div>
                ...
                <div class="base-product-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-footer">
                            <span class="card-price"><%= FormatMoney(rsProducts("BasePrice")) %> 起</span>
                            <a href="/product.asp?id=<%= rsProducts("ProductID") %>" class="btn btn-primary">开始定制</a>
                        </div>
                    </div>
                </div>
                <%
        ...
        <section class="customize-section notes-section">
            <div class="section-header">
                <h2><i class="fas fa-layer-group"></i> 香调层次说明</h2>
                <p>了解香水的三层结构，帮助您做出更好的选择</p>
            </div>
            <div class="notes-explanation">
                <div class="note-level top-note">
                    ...
                    <div class="note-content">
                        <h3>前调 (Top Notes)</h3>
                        <p>香水的第一印象，喷洒后立即感受到的香气。通常由轻盈、清新的香调组成，如柑橘、薰衣草、薄荷等。持续时间约15-30分钟。</p>
                ...
                <div class="note-level middle-note">
                    ...
                    <div class="note-content">
                        <h3>中调 (Heart Notes)</h3>
                        <p>香水的核心灵魂，在前调消散后显现。通常由花香、果香等构成，是整体香氛的主体。持续时间约2-4小时。</p>
                        <div class="available-notes">
                            <%
                            Dim rsMiddleNotes
                ...
                <div class="note-level base-note">
                    ...
                    <div class="note-content">
                        <h3>后调 (Base Notes)</h3>
                        <p>香水最持久的部分，为整体香氛提供深度和持久力。通常由木质香、麝香、琥珀等组成。持续时间可达数小时甚至一整天。</p>
                        <div class="available-notes">
                            <%
                            Dim rsBaseNotes
        ...
        <section class="customize-section bottles-section">
            <div class="section-header">
                <h2><i class="fas fa-wine-bottle"></i> 精美瓶身</h2>
                <p>选择心仪的瓶身，完美呈现您的专属香水</p>
            </div>
            <div class="bottles-grid">
                ...
                %>
                    ...
                    <% Else %>
                    <span class="bottle-price">免费</span>
                    <% End If %>
                </div>
                <%
                        rsBottles.MoveNext
            ...
            <div class="faq-list">
                <div class="faq-item">
                    <div class="faq-question">
                        <span>定制香水需要多长时间？</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>定制香水需要3-5个工作日进行调配和制作，之后通过顺丰快递发货，一般2-5天送达。</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>由于定制香水是根据您的个人选择专门调配的，非质量问题不支持退换。如果收到的产品存在质量问题，请在签收后7天内联系客服处理。</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <span>香水的留香时间有多长？</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>我们的香水均采用优质香精，一般留香时间为6-8小时，具体时长会因个人肤质、环境温度等因素有所不同。</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-question">
                        <span>如何选择适合自己的香调？</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>建议根据您的个人喜好和使用场合来选择：日常使用可选清新淡雅的花香调或海洋调；约会或晚宴可选浓郁神秘的东方调；职场可选沉稳内敛的木质调。</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="customize-cta">
            <div class="cta-content">
                <h2>准备好创造您的专属香水了吗？</h2>
                <p>选择一款基础香型，开始您的定制之旅</p>
                <a href="#" onclick="scrollToProducts()" class="btn btn-primary btn-lg">立即开始</a>
            </div>
        </section>
    </div>
</div>
