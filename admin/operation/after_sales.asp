...
<head>
    ...
    <style>
        ...
        .badge-refund { background: rgba(233,30,99,0.2); color: #F48FB1; }
        .badge-return { background: rgba(33,150,243,0.2); color: #90CAF9; }
        .badge-exchange { background: rgba(156,39,176,0.2); color: #CE93D8; }
        ...
        .form-group select, .form-group textarea { width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.12); border-radius: 8px; background: #1a1a2e; color: #e0e0e0; font-size: 14px; }
                ...
                <tbody>
                    ...
                    Do While Not rsAfterSales.EOF
                        ...
                        Select Case rsAfterSales("RequestType")
                            Case "refund": typeBadge = "badge-refund"
                            Case "return": typeBadge = "badge-return"
                            Case "exchange": typeBadge = "badge-exchange"
                            Case Else: typeBadge = ""
                        End Select
                        Dim statusBadge
                        Select Case rsAfterSales("Status")
                            Case "pending": statusBadge = "badge-pending"
                            Case "approved": statusBadge = "badge-approved"
                            Case "rejected": statusBadge = "badge-rejected"
                    ...
                    <tr>
                        ...
                        <td><span class="badge <%= typeBadge %>"><%= requestTypeCN %></span></td>
                        ...
                        <td><span class="badge <%= statusBadge %>"><%= rsAfterSales("Status") %></span></td>
                        ...
                        <td>
                            ...
                            <% Else %>
                            <span style="font-size:12px;color:#666;"><%= rsAfterSales("AdminNotes") %></span>
                            <% End If %>
                        </td>
                    </tr>
                    <%
