...
var districtData = {
    ...
    "沈阳市": ["和平区", "沈河区", "大东区", "皇姑区", "铁西区", "苏家屯区", "浑南区", "于洪区", "辽中区", "新民市", "法库县", "康平县"],
    ...
    "东莞市": ["东城街道", "南城街道", "万江街道", "莞城街道", "石碣镇", "石龙镇", "茶山镇", "石排镇", "企石镇", "横沥镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "寮步镇", "樟木头镇", "大朗镇", "黄江镇", "清溪镇", "塘厦镇", "凤岗镇", "大岭山镇", "长安镇", "虎门镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "望牛墩镇", "中堂镇", "高埗镇", "松山湖"],
    ...
    "东区": ["筲箕湾", "西湾河", "鲗鱼涌", "太古", "北角", "鲗鱼涌"],
    "南区": ["香港仔", "鸭脷洲", "黄竹坑", "深水湾", "浅水湾", "赤柱", "大潭", "石澳"],
    "油尖旺区": ["尖沙咀", "佐敦", "油麻地", "旺角", "太子", "大角咀"],
    "深水埗区": ["深水埗", "长沙湾", "荔枝角", "石硖尾", "又一村", "大窝坪"],
    "九龙城区": ["红磡", "土瓜湾", "马头围", "何文田", "九龙城", "新蒲岗"],
    "黄大仙区": ["黄大仙", "钻石山", "慈云山", "彩虹", "牛池湾", "新蒲岗"],
    "观塘区": ["观塘", "牛头角", "九龙湾", "秀茂坪", "蓝田", "油塘", "调景岭"],
    "葵青区": ["葵涌", "大窝口", "葵盛", "青衣", "青衣岛", "马湾"],
    "荃湾区": ["荃湾", "葵盛", "青衣", "马湾", "大屿山东北部"],
    "屯门区": ["屯门", "安定", "友爱", "兆麟", "丰景园", "大榄"],
    "元朗区": ["元朗", "天水围", "屏山", "流浮山", "厦村", "横洲"],
    "北区": ["上水", "粉岭", "沙头角", "打鼓岭"],
    "大埔区": ["大埔", "大埔墟", "太和", "林村", "吐露港", "船湾"],
    "沙田区": ["沙田", "大围", "火炭", "马鞍山", "石门", "小沥源"],
    "西贡区": ["西贡", "将军澳", "调景岭", "坑口", "蚝涌", "白沙湾"],
    "离岛区": ["大屿山", "香港国际机场", "东涌", "昂坪", "大澳", "梅窝", "长洲", "南丫岛", "坪洲", "蒲苔岛"],
    
    // 澳门区县数据
    "花地玛堂区": ["花地玛", "关闸", "台山", "黑沙环", "祐汉", "筷子基"],
    "圣安多尼堂区": ["新桥", "沙梨头", "望德", "塔石", "水坑尾"],
    "大堂区": ["南湾", "新马路", "议事亭前地", "大堂", "板樟堂"],
    "望德堂区": ["望德", "龙环葡韵", "氹仔", "官也街"],
    "风顺堂区": ["妈阁", "西湾", "南湾湖", "葡京"],
    "嘉模堂区": ["氹仔", "路氹城", "威尼斯人", "新濠天地"],
    "路凼填海区": ["路氹城", "新濠影汇", "伦敦人", "巴黎人"],
    "圣方济各堂区": ["路环", "黑沙", "竹湾", "石排湾", "九澳"],
    
    // 台湾地区区县数据
    "台北市": ["中正区", "大同区", "中山区", "松山区", "大安区", "万华区", "信义区", "士林区", "北投区", "内湖区", "南港区", "文山区"],
    "新北市": ["板桥区", "新庄区", "中和区", "永和区", "土城区", "树林区", "三重区", "芦洲区", "新店区", "淡水区", "汐止区", "瑞芳区", "三峡区", "莺歌区", "万里区", "金山区", "深坑区", "石碇区", "平溪区", "双溪区", "贡寮区", "坪林区", "乌来区", "五股区", "泰山区", "林口区", "八里区", "三芝区", "石门区"],
    "桃园市": ["中坜区", "平镇区", "龙潭区", "杨梅区", "新屋区", "观音区", "桃园区", "龟山区", "八德区", "大溪区", "复兴区", "大园区", "芦竹区"],
    "台中市": ["中区", "东区", "南区", "西区", "北区", "北屯区", "西屯区", "南屯区", "太平区", "大里区", "雾峰区", "乌日区", "丰原区", "后里区", "石冈区", "东势区", "和平区", "新社区", "潭子区", "大雅区", "神冈区", "清水区", "梧栖区", "沙鹿区", "龙井区", "梨山风景区"],
    ...
    "高雄市": ["新兴区", "前金区", "芩雅区", "盐埕区", "鼓山区", "旗津区", "前镇区", "三民区", "左营区", "楠梓区", "小港区", "苓雅区", "仁武区", "大社区", "东沙群岛", "南沙群岛", "那玛夏区", "桃源区", "茂林区"],
    "基隆市": ["中正区", "七堵区", "暖暖区", "仁爱区", "中山区", "安乐区", "信义区"],
    "新竹市": ["东区", "北区", "香山区"],
    "嘉义市": ["东区", "西区"],
    "新竹县": ["竹北市", "竹东镇", "新埔镇", "关西镇", "湖口乡", "新丰乡", "芎林乡", "横山乡", "北埔乡", "宝山乡", "峨眉乡", "尖石乡", "五峰乡"],
    "苗栗县": ["苗栗市", "通霄镇", "苑里镇", "竹南镇", "头份镇", "后龙镇", "卓兰镇", "大湖乡", "公馆乡", "铜锣乡", "南庄乡", "头屋乡", "三义乡", "西湖乡", "造桥乡", "三湾乡", "狮潭乡", "泰安乡"],
    "彰化县": ["彰化市", "鹿港镇", "和美镇", "线西乡", "伸港乡", "福兴乡", "秀水乡", "花坛乡", "芬园乡", "员林镇", "溪湖镇", "田中镇", "北斗镇", "田尾乡", "埤头乡", "溪州乡", "竹塘乡", "二林镇", "大城乡", "芳苑乡", "二水乡"],
    ...
    "花莲县": ["花莲市", "凤林镇", "玉里镇", "新城乡", "吉安乡", "寿丰乡", "光复乡", "丰滨乡", "瑞穗乡", "万荣乡", "富里乡", "秀林乡", "卓溪乡"],
